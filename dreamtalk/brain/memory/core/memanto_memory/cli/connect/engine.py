...
from dreamtalk.brain.memory.core.memanto_memory.cli.connect.agent_registry import AGENT_REGISTRY, AgentDef
from dreamtalk.brain.memory.core.memanto_memory.cli.connect.templates import (
    MEMANTO_SENTINEL,
