...
def config_backend(
    ...
    if target_backend == Backend.CLOUD:
        if not config_manager.get_api_key():
            from dreamtalk.brain.memory.core.memanto_memory.cli.commands.core import _cloud_setup

            _cloud_setup()
    else:
        from dreamtalk.brain.memory.core.memanto_memory.cli.commands.core import _onprem_setup
    ...
    try:
        from dreamtalk.brain.memory.core.memanto_memory.app.clients.moorcheh import moorcheh_client as _singleton
        from dreamtalk.brain.memory.core.memanto_memory.app.config import settings as _settings
