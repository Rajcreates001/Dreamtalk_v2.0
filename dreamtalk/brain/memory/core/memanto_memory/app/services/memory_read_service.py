...
from dreamtalk.brain.memory.core.memanto_memory.app.utils.errors import MemoryError
...
class MemoryReadService:
    ...
    def namespace_service(self):
        if self._namespace_service is None:
            from dreamtalk.brain.memory.core.memanto_memory.app.services.namespace_service import NamespaceService
    ...
    def search_multi_scope(
        ...
        try:
            ...
            from dreamtalk.brain.memory.core.memanto_memory.memanto.app.constants import ScopeType
    ...
    def search_as_of(
        ...
        """
        try:
            from dreamtalk.brain.memory.core.memanto_memory.app.utils.temporal_helpers import parse_iso_timestamp
    ...
    def generate_answer(
        ...
        try:
            ...
            if scope_type and scope_id:
                ...
                from dreamtalk.brain.memory.core.memanto_memory.app.constants import ScopeType
