    ...
    def get_client(self, api_key: str | None = None) -> Any:
        ...
        if self._backend() == Backend.ON_PREM:
            if self._client is None:
                from dreamtalk.brain.memory.core.memanto_memory.app.clients.onprem import OnPremClient
    ...
    def get_async_client(self, api_key: str | None = None) -> Any:
        ...
        if self._backend() == Backend.ON_PREM:
            if self._async_client is None:
                from dreamtalk.brain.memory.core.memanto_memory.app.clients.onprem import AsyncOnPremClient
