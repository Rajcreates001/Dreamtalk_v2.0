...
from dreamtalk.brain.memory.core.letta_memory.constants import FUNC_FAILED_HEARTBEAT_MESSAGE, REQ_HEARTBEAT_MESSAGE, REQUEST_HEARTBEAT_PARAM
...
from dreamtalk.brain.memory.core.letta_memory.llm_api.anthropic_constants import ANTHROPIC_MAX_STRICT_TOOLS, ANTHROPIC_STRICT_MODE_ALLOWLIST
from dreamtalk.brain.memory.core.letta_memory.llm_api.error_utils import is_insufficient_credits_message
from dreamtalk.brain.memory.core.letta_memory.llm_api.helpers import add_inner_thoughts_to_functions, unpack_all_inner_thoughts_from_kwargs
from dreamtalk.brain.memory.core.letta_memory.llm_api.llm_client_base import LLMClientBase
from dreamtalk.brain.memory.core.letta_memory.local_llm.constants import INNER_THOUGHTS_KWARG, INNER_THOUGHTS_KWARG_DESCRIPTION
...
from dreamtalk.brain.memory.core.letta_memory.schemas.openai.chat_completion_request import Tool as OpenAITool
...
class AnthropicClient(LLMClientBase):
    ...
    async def _request_via_streaming(self, request_data: dict, llm_config: LLMConfig, betas: list[str]) -> dict:
        ...
        See: https://github.com/anthropics/anthropic-sdk-python#long-requests
        """
        from dreamtalk.brain.memory.core.letta_memory.interfaces.anthropic_parallel_tool_call_streaming_interface import (
