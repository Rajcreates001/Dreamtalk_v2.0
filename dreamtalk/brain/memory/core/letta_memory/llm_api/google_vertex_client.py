...
from dreamtalk.brain.memory.core.letta_memory.constants import NON_USER_MSG_PREFIX
...
from dreamtalk.brain.memory.core.letta_memory.helpers.json_helpers import json_dumps, json_loads, sanitize_unicode_surrogates
...
from dreamtalk.brain.memory.core.letta_memory.local_llm.json_parser import clean_json_string_extra_backslash
...
from dreamtalk.brain.memory.core.letta_memory.schemas.openai.chat_completion_request import Tool, Tool as OpenAITool
from dreamtalk.brain.memory.core.letta_memory.schemas.openai.chat_completion_response import ChatCompletionResponse, Choice, FunctionCall, Message, ToolCall, UsageStatistics
from dreamtalk.brain.memory.core.letta_memory.schemas.usage import LettaUsageStatistics
from dreamtalk.brain.memory.core.letta_memory.settings import model_settings, settings
...
class GoogleVertexClient(LLMClientBase):
    ...
    def convert_tools_to_google_ai_format(self, tools: List[Tool], llm_config: LLMConfig) -> List[dict]:
        ...
        for func in function_list:
            ...
            if llm_config.put_inner_thoughts_in_kwargs:
                from dreamtalk.brain.memory.core.letta_memory.local_llm.constants import INNER_THOUGHTS_KWARG_DESCRIPTION, INNER_THOUGHTS_KWARG_VERTEX
                ...
                for response_message in parts:
                    ...
                    if response_message.function_call:
                        ...
                        if llm_config.put_inner_thoughts_in_kwargs:
                            ...
                            from dreamtalk.brain.memory.core.letta_memory.local_llm.constants import INNER_THOUGHTS_KWARG_VERTEX
    ...
    async def count_tokens(
        ...
        """
        from dreamtalk.brain.memory.core.letta_memory.llm_api.google_constants import GOOGLE_MODEL_FOR_API_KEY_CHECK
