...
from dreamtalk.brain.memory.core.letta_memory import __version__
from dreamtalk.brain.memory.core.letta_memory.orm import Agent, Message as MessageModel
...
from dreamtalk.brain.memory.core.letta_memory.serialize_schemas.marshmallow_agent_environment_variable import SerializedAgentEnvironmentVariableSchema
from dreamtalk.brain.memory.core.letta_memory.serialize_schemas.marshmallow_base import BaseSchema
from dreamtalk.brain.memory.core.letta_memory.serialize_schemas.marshmallow_block import SerializedBlockSchema
from dreamtalk.brain.memory.core.letta_memory.serialize_schemas.marshmallow_custom_fields import EmbeddingConfigField, LLMConfigField, ToolRulesField
from dreamtalk.brain.memory.core.letta_memory.serialize_schemas.marshmallow_message import SerializedMessageSchema
from dreamtalk.brain.memory.core.letta_memory.serialize_schemas.marshmallow_tag import SerializedAgentTagSchema
from dreamtalk.brain.memory.core.letta_memory.serialize_schemas.marshmallow_tool import SerializedToolSchema
...
class MarshmallowAgentSchema(BaseSchema):
    ...
    def sanitize_ids(self, data: Dict, **kwargs):
        ...
        data[self.FIELD_VERSION] = __version__
    ...
    def check_version(self, data, **kwargs):
        ...
        if version != __version__:
            print(f"Version mismatch: expected {__version__}, got {version}")
