...
from dreamtalk.brain.memory.core.letta_memory.adapters.sglang_native_adapter import SGLangNativeAdapter
from dreamtalk.brain.memory.core.letta_memory.adapters.simple_llm_request_adapter import SimpleLLMRequestAdapter
from dreamtalk.brain.memory.core.letta_memory.adapters.simple_llm_stream_adapter import SimpleLLMStreamAdapter
...
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import LLMCallType
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_message import (
    ApprovalReturn,
    CompactionStats,
    EventMessage,
    LettaErrorMessage,
...
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_response import LettaResponse, TurnTokenData
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_stop_reason import LettaStopReason, StopReasonType
from dreamtalk.brain.memory.core.letta_memory.schemas.message import Message, MessageCreate, ToolReturn
from dreamtalk.brain.memory.core.letta_memory.schemas.openai.chat_completion_response import ChoiceLogprobs, ToolCall, ToolCallDenial, UsageStatistics
...
from dreamtalk.brain.memory.core.letta_memory.services.llm_router import get_llm_routing_client
from dreamtalk.brain.memory.core.letta_memory.services.provider_manager import AUTO_MODE_HANDLES
from dreamtalk.brain.memory.core.letta_memory.services.summarizer.compact import compact_messages
from dreamtalk.brain.memory.core.letta_memory.services.summarizer.summarizer_config import CompactionSettings
from dreamtalk.brain.memory.core.letta_memory.services.summarizer.summarizer_sliding_window import count_tokens
from dreamtalk.brain.memory.core.letta_memory.services.summarizer.thresholds import get_compaction_trigger_threshold
...
from dreamtalk.brain.memory.core.letta_memory.utils import safe_create_task_with_return, validate_function_response
        ...
        if not tool_calls and not tool_call_denials and not tool_returns:
            ...
            if content is None or len(content) == 0:
                ...
                if uncalled:
                    ...
                    from dreamtalk.brain.memory.core.letta_memory.server.rest_api.utils import create_heartbeat_system_message
