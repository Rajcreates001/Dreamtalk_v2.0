...
from dreamtalk.brain.memory.core.letta_memory.errors import LettaError, PendingApprovalError
...
from dreamtalk.brain.memory.core.letta_memory.schemas.message import ApprovalCreate, Message, MessageCreate, MessageCreateBase
...
from dreamtalk.brain.memory.core.letta_memory.server.rest_api.utils import create_approval_response_message_from_input, create_input_messages
...
def merge_and_validate_prefilled_args(tool: "Tool", llm_args: Dict[str, Any], prefilled_args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    """
    from dreamtalk.brain.memory.core.letta_memory.schemas.tool import Tool  # local import to avoid circulars in type hints
