...
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import StepStatus
...
if TYPE_CHECKING:
    ...
    from dreamtalk.brain.memory.core.letta_memory.orm.step_metrics import StepMetrics
