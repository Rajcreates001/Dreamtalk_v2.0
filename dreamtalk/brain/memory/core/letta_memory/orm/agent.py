...
from dreamtalk.brain.memory.core.letta_memory.orm.custom_columns import CompactionSettingsColumn, EmbeddingConfigColumn, LLMConfigColumn, ResponseFormatColumn, ToolRulesColumn
...
from dreamtalk.brain.memory.core.letta_memory.orm.mixins import OrganizationMixin, ProjectMixin, TemplateEntityMixin, TemplateMixin
from dreamtalk.brain.memory.core.letta_memory.orm.organization import Organization
from dreamtalk.brain.memory.core.letta_memory.orm.sqlalchemy_base import SqlalchemyBase
from dreamtalk.brain.memory.core.letta_memory.schemas.agent import AgentState as PydanticAgentState
...
from dreamtalk.brain.memory.core.letta_memory.schemas.response_format import ResponseFormatUnion
from dreamtalk.brain.memory.core.letta_memory.schemas.tool_rule import ToolRule
from dreamtalk.brain.memory.core.letta_memory.utils import bounded_gather, calculate_file_defaults_based_on_context_window

if TYPE_CHECKING:
    from dreamtalk.brain.memory.core.letta_memory.orm.agents_tags import AgentsTags
    from dreamtalk.brain.memory.core.letta_memory.orm.archives_agents import ArchivesAgents
    from dreamtalk.brain.memory.core.letta_memory.orm.conversation import Conversation
    from dreamtalk.brain.memory.core.letta_memory.orm.files_agents import FileAgent
    ...
    from dreamtalk.brain.memory.core.letta_memory.orm.source import Source
...
class Agent(SqlalchemyBase, OrganizationMixin, ProjectMixin, TemplateEntityMixin, TemplateMixin, AsyncAttrs):
    ...
    async def to_pydantic_async(
        ...
        if decrypt:
            ...
            from dreamtalk.brain.memory.core.letta_memory.schemas.environment_variables import AgentEnvironmentVariable
