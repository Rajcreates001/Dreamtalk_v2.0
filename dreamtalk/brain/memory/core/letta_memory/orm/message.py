...
if TYPE_CHECKING:
    ...
    from dreamtalk.brain.memory.core.letta_memory.orm.step import Step

from openai.types.chat.chat_completion_message_tool_call import ChatCompletionMessageToolCall as OpenAIToolCall
from sqlalchemy import BigInteger, FetchedValue, ForeignKey, Index, event, text
from sqlalchemy.orm import Mapped, Session, mapped_column, relationship

from dreamtalk.brain.memory.core.letta_memory.orm.custom_columns import ApprovalsColumn, MessageContentColumn, ToolCallColumn, ToolReturnColumn
from dreamtalk.brain.memory.core.letta_memory.orm.mixins import AgentMixin, OrganizationMixin
...
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_message_content import MessageContent, TextContent, TextContent as PydanticTextContent
from dreamtalk.brain.memory.core.letta_memory.schemas.message import Message as PydanticMessage, ToolReturn
