...
def _get_readiness_settings():
    from dreamtalk.brain.memory.core.letta_memory.settings import readiness_settings
...
class LoadGate:
    ...
    def on_admission_wait(self, wait_ms: float) -> None:
        ...
        try:
            ...
            from dreamtalk.brain.memory.core.letta_memory.monitoring.readiness_state import get_readiness_state
    ...
    def _maybe_degrade_fg(self, now: float, count: int) -> None:
        from dreamtalk.brain.memory.core.letta_memory.monitoring.readiness_state import get_readiness_state, mark_degraded
    ...
    def _maybe_recover_fg(self, now: float) -> None:
        from dreamtalk.brain.memory.core.letta_memory.monitoring.readiness_state import clear_degraded, get_readiness_state
