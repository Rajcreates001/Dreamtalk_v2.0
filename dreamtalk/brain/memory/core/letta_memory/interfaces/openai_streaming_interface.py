...
from dreamtalk.brain.memory.core.letta_memory.constants import DEFAULT_MESSAGE_TOOL, DEFAULT_MESSAGE_TOOL_KWARG
from dreamtalk.brain.memory.core.letta_memory.llm_api.error_utils import is_context_window_overflow_message
from dreamtalk.brain.memory.core.letta_memory.llm_api.openai_client import is_openai_reasoning_model
...
from dreamtalk.brain.memory.core.letta_memory.schemas.openai.chat_completion_response import FunctionCall, ToolCall
from dreamtalk.brain.memory.core.letta_memory.server.rest_api.json_parser import OptimisticJSONParser
from dreamtalk.brain.memory.core.letta_memory.server.rest_api.streaming_response import RunCancelledException
from dreamtalk.brain.memory.core.letta_memory.server.rest_api.utils import decrement_message_uuid
...
from dreamtalk.brain.memory.core.letta_memory.streaming_utils import (
...
class SimpleOpenAIResponsesStreamingInterface:
    ...
    async def _process_event(
        ...
        # Error / failure events (WebSocket mode may emit these explicitly)
            ...
            from dreamtalk.brain.memory.core.letta_memory.errors import LLMError
