...
from dreamtalk.brain.memory.core.letta_memory.database_utils import get_database_uri_for_context
        ...
        for attempt in range(max_retries):
            try:
                ...
                if attempt < max_retries - 1:
                    ...
                    from dreamtalk.brain.memory.core.letta_memory.errors import LettaServiceUnavailableError
