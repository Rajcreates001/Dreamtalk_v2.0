...
from dreamtalk.brain.memory.core.letta_memory.constants import DEFAULT_GENERATE_TOOL_MODEL_HANDLE
...
from dreamtalk.brain.memory.core.letta_memory.functions.functions import derive_openai_json_schema
from dreamtalk.brain.memory.core.letta_memory.functions.mcp_client.exceptions import MCPTimeoutError
from dreamtalk.brain.memory.core.letta_memory.functions.mcp_client.types import MCPTool, SSEServerConfig, StdioServerConfig, StreamableHTTPServerConfig
from dreamtalk.brain.memory.core.letta_memory.helpers.decorators import deprecated
...
from dreamtalk.brain.memory.core.letta_memory.orm.mcp_oauth import OAuthSessionStatus
from dreamtalk.brain.memory.core.letta_memory.prompts.gpt_system import get_system_text
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import AgentType, LLMCallType, MessageRole, ToolType
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_message import ToolReturnMessage
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_message_content import TextContent
from dreamtalk.brain.memory.core.letta_memory.schemas.mcp import UpdateSSEMCPServer, UpdateStdioMCPServer, UpdateStreamableHTTPMCPServer
...
from dreamtalk.brain.memory.core.letta_memory.schemas.tool import Tool, ToolCreate, ToolRunFromSource, ToolSearchRequest, ToolSearchResult, ToolUpdate
...
from dreamtalk.brain.memory.core.letta_memory.server.rest_api.streaming_response import StreamingResponseWithStatusCode
from dreamtalk.brain.memory.core.letta_memory.server.server import SyncServer
from dreamtalk.brain.memory.core.letta_memory.services.mcp.oauth_utils import MCPOAuthSession, drill_down_exception, oauth_stream_event
...
from dreamtalk.brain.memory.core.letta_memory.validators import ToolId
...
async def generate_json_schema(
    ...
    if request.source_type == "typescript":
        from dreamtalk.brain.memory.core.letta_memory.functions.typescript_parser import derive_typescript_json_schema
