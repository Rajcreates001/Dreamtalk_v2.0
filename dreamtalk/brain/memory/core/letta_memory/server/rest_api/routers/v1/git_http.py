...
async def _sync_after_push(actor_id: str, agent_id: str) -> None:
    ...
    from dreamtalk.brain.memory.core.letta_memory.services.block_manager_git import GitEnabledBlockManager
    ...
    expected_labels = set()
    from dreamtalk.brain.memory.core.letta_memory.services.memory_repo.block_markdown import parse_block_markdown
