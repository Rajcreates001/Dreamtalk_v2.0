...
from dreamtalk.brain.memory.core.letta_memory.validators import PRIMITIVE_ID_PATTERNS
...
async def get_letta_server() -> "SyncServer":
    with tracer.start_as_current_span("dependency.get_letta_server"):
        ...
        from dreamtalk.brain.memory.core.letta_memory.server.rest_api.app import server
