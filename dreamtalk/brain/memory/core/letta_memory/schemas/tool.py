...
from dreamtalk.brain.memory.core.letta_memory.functions.functions import get_json_schema_from_module
from dreamtalk.brain.memory.core.letta_memory.functions.mcp_client.types import MCPTool
from dreamtalk.brain.memory.core.letta_memory.functions.schema_generator import generate_tool_schema_for_mcp
...
from dreamtalk.brain.memory.core.letta_memory.schemas.npm_requirement import NpmRequirement
...
class ToolCreate(LettaBase):
    ...
    def from_mcp(cls, mcp_server_name: str, mcp_tool: MCPTool) -> "ToolCreate":
        from dreamtalk.brain.memory.core.letta_memory.functions.helpers import generate_mcp_tool_wrapper
