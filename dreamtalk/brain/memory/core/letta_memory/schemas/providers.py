...
import aiohttp
import requests
from dreamtalk.brain.memory.core.letta_memory.llm_api.azure_openai import get_azure_chat_completions_endpoint, get_azure_embeddings_endpoint
from dreamtalk.brain.memory.core.letta_memory.llm_api.azure_openai_constants import AZURE_MODEL_TO_CONTEXT_LENGTH
from pydantic import BaseModel, Field, model_validator

from dreamtalk.brain.memory.core.letta_memory.constants import DEFAULT_EMBEDDING_CHUNK_SIZE, LETTA_MODEL_ENDPOINT, LLM_MAX_TOKENS, MIN_CONTEXT_WINDOW
from dreamtalk.brain.memory.core.letta_memory.schemas.embedding_config import EmbeddingConfig
from dreamtalk.brain.memory.core.letta_memory.schemas.embedding_config_overrides import EMBEDDING_HANDLE_OVERRIDES
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import ProviderCategory, ProviderType
...
from dreamtalk.brain.memory.core.letta_memory.schemas.llm_config_overrides import LLM_HANDLE_OVERRIDES
from dreamtalk.brain.memory.core.letta_memory.settings import model_settings
...
class OpenAIProvider(Provider):
    ...
    def check_api_key(self):
        from dreamtalk.brain.memory.core.letta_memory.llm_api.openai import openai_check_valid_api_key

        openai_check_valid_api_key(self.base_url, self.api_key)

    def _get_models(self) -> List[dict]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.openai import openai_get_model_list
    ...
    async def _get_models_async(self) -> List[dict]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.openai import openai_get_model_list_async
...
class AnthropicProvider(Provider):
    ...
    def check_api_key(self):
        from dreamtalk.brain.memory.core.letta_memory.llm_api.anthropic import anthropic_check_valid_api_key

        anthropic_check_valid_api_key(self.api_key)

    def list_llm_models(self) -> List[LLMConfig]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.anthropic import anthropic_get_model_list

        models = anthropic_get_model_list(api_key=self.api_key)
        return self._list_llm_models(models)

    async def list_llm_models_async(self) -> List[LLMConfig]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.anthropic import anthropic_get_model_list_async

        models = await anthropic_get_model_list_async(api_key=self.api_key)
        return self._list_llm_models(models)

    def _list_llm_models(self, models) -> List[LLMConfig]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.anthropic import MODEL_LIST
...
class MistralProvider(Provider):
    ...
    def list_llm_models(self) -> List[LLMConfig]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.mistral import mistral_get_model_list
...
class GoogleAIProvider(Provider):
    ...
    def check_api_key(self):
        from dreamtalk.brain.memory.core.letta_memory.llm_api.google_ai_client import google_ai_check_valid_api_key

        google_ai_check_valid_api_key(self.api_key)

    def list_llm_models(self):
        from dreamtalk.brain.memory.core.letta_memory.llm_api.google_ai_client import google_ai_get_model_list
    ...
    async def list_llm_models_async(self):
        ...
        from dreamtalk.brain.memory.core.letta_memory.llm_api.google_ai_client import google_ai_get_model_list_async
    ...
    def get_model_context_window(self, model_name: str) -> Optional[int]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.google_ai_client import google_ai_get_model_context_window
    ...
    async def get_model_context_window_async(self, model_name: str) -> Optional[int]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.google_ai_client import google_ai_get_model_context_window_async
...
class GoogleVertexProvider(Provider):
    ...
    def list_llm_models(self) -> List[LLMConfig]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.google_constants import GOOGLE_MODEL_TO_CONTEXT_LENGTH
    ...
    def list_embedding_models(self) -> List[EmbeddingConfig]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.google_constants import GOOGLE_EMBEDING_MODEL_TO_DIM
...
class AzureProvider(Provider):
    ...
    def list_llm_models(self) -> List[LLMConfig]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.azure_openai import azure_openai_get_chat_completion_model_list
    ...
    def list_embedding_models(self) -> List[EmbeddingConfig]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.azure_openai import azure_openai_get_embeddings_model_list
...
class BedrockProvider(Provider):
    ...
    def check_api_key(self):
        ...
        from dreamtalk.brain.memory.core.letta_memory.llm_api.aws_bedrock import bedrock_get_model_list

        from dreamtalk.brain.memory.core.letta_memory.errors import LLMAuthenticationError
    ...
    async def list_llm_models_async(self) -> List[LLMConfig]:
        from dreamtalk.brain.memory.core.letta_memory.llm_api.aws_bedrock import bedrock_get_model_list_async
    ...
    def get_model_context_window(self, model_name: str) -> Optional[int]:
        ...
        from dreamtalk.brain.memory.core.letta_memory.llm_api.aws_bedrock import bedrock_get_model_context_window
