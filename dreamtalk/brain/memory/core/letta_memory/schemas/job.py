...
if TYPE_CHECKING:
    from dreamtalk.brain.memory.core.letta_memory.schemas.letta_request import LettaRequest
...
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import JobStatus, JobType
