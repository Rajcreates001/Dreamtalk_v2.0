...
from dreamtalk.brain.memory.core.letta_memory.constants import DEFAULT_EMBEDDING_CHUNK_SIZE, LLM_MAX_CONTEXT_WINDOW
from dreamtalk.brain.memory.core.letta_memory.errors import ErrorCode, LLMAuthenticationError, LLMError, LLMPermissionDeniedError
...
from dreamtalk.brain.memory.core.letta_memory.schemas.providers.base import Provider
...
class OpenAIProvider(Provider):
    ...
    async def get_default_max_output_tokens_async(self, model_name: str) -> int:
        ...
        """
        from dreamtalk.brain.memory.core.letta_memory.model_specs.litellm_model_specs import get_max_output_tokens
    ...
    async def get_model_context_window_size_async(self, model_name: str) -> int | None:
        ...
        """
        from dreamtalk.brain.memory.core.letta_memory.model_specs.litellm_model_specs import get_context_window
