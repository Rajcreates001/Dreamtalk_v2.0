...
from dreamtalk.brain.memory.core.letta_memory.errors import ErrorCode, LLMAuthenticationError, LLMError
...
class ChatGPTOAuthProvider(Provider):
    ...
    async def _update_stored_credentials(self, creds: ChatGPTOAuthCredentials, actor: Optional["User"] = None) -> None:
        ...
        if actor and self.id:
            try:
                from dreamtalk.brain.memory.core.letta_memory.schemas.providers.base import ProviderUpdate
