...
from dreamtalk.brain.memory.core.letta_memory.constants import DEFAULT_MESSAGE_TOOL, DEFAULT_MESSAGE_TOOL_KWARG, REQUEST_HEARTBEAT_PARAM, TOOL_CALL_ID_MAX_LEN
from dreamtalk.brain.memory.core.letta_memory.helpers.datetime_helpers import get_utc_time, is_utc_datetime
from dreamtalk.brain.memory.core.letta_memory.helpers.json_helpers import json_dumps
from dreamtalk.brain.memory.core.letta_memory.local_llm.constants import INNER_THOUGHTS_KWARG, INNER_THOUGHTS_KWARG_VERTEX
...
from dreamtalk.brain.memory.core.letta_memory.system import unpack_message
from dreamtalk.brain.memory.core.letta_memory.utils import parse_json, parse_json_or_wrap_raw, sanitize_tool_call_id, validate_function_response
    ...
    def to_anthropic_dict(
        ...
        if self.role == "system":
            ...
            if system_text is None:
                text_parts = [c.text for c in (self.content or []) if isinstance(c, TextContent)]
                if not text_parts:
                    from dreamtalk.brain.memory.core.letta_memory.log import get_logger as _get_logger
