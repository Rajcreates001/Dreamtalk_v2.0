...
async def convert_generic_to_union(server) -> MCPServerUnion:
    """
    Convert a generic MCPServer (from dreamtalk.brain.memory.core.letta_memory.schemas.mcp) to the appropriate MCPServerUnion type
    based on the server_type field.

    This is used to convert internal MCPServer representations to the API response types.

    Args:
        server: A GenericMCPServer instance from dreamtalk.brain.memory.core.letta_memory.schemas.mcp

    Returns:
        The appropriate MCPServerUnion type (StdioMCPServer, SSEMCPServer, or StreamableHTTPMCPServer)
    """
    # Import here to avoid circular dependency
    from dreamtalk.brain.memory.core.letta_memory.schemas.mcp import MCPServer as GenericMCPServer
...
def convert_update_to_internal(request: UpdateMCPServerRequest):
    ...
    from dreamtalk.brain.memory.core.letta_memory.functions.mcp_client.types import MCPServerType as MCPType, StdioServerConfig as StdioCfg
