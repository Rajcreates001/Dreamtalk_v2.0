...
from dreamtalk.brain.memory.core.letta_memory.model_aliases import get_deprecated_google_handle_replacement, get_deprecated_google_model_replacement
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import AgentType, ProviderCategory
from dreamtalk.brain.memory.core.letta_memory.schemas.response_format import ResponseFormatUnion

if TYPE_CHECKING:
    from dreamtalk.brain.memory.core.letta_memory.schemas.model import ModelSettings
...
class LLMConfig(BaseModel):
    ...
    def validate_codex_reasoning_effort(cls, values):
        ...
        """
        from dreamtalk.brain.memory.core.letta_memory.llm_api.openai_client import does_not_support_minimal_reasoning
    ...
    def _to_model_settings(self) -> "ModelSettings":
        ...
        """
        from dreamtalk.brain.memory.core.letta_memory.schemas.model import (
        ...
        if self.model_endpoint_type == "openai":
            ...
            from dreamtalk.brain.memory.core.letta_memory.schemas.model import ZAIThinking
            ...
            from dreamtalk.brain.memory.core.letta_memory.schemas.model import BasetenModelSettings
    ...
    def apply_reasoning_setting_to_config(cls, config: "LLMConfig", reasoning: bool, agent_type: Optional["AgentType"] = None):
        ...
        """
        from dreamtalk.brain.memory.core.letta_memory.llm_api.openai_client import does_not_support_minimal_reasoning, supports_none_reasoning_effort
