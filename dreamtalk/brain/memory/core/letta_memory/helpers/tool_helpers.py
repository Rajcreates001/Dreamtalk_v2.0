...
from dreamtalk.brain.memory.core.letta_memory.constants import MODAL_VERSION_HASH_LENGTH
...
def generate_modal_function_name(tool_name: str, organization_id: str, project_id: str = "default") -> str:
    ...
    """
    from dreamtalk.brain.memory.core.letta_memory.constants import MAX_TOOL_NAME_LENGTH
