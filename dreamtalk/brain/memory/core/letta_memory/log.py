...
from dreamtalk.brain.memory.core.letta_memory.log_context import get_log_context
from dreamtalk.brain.memory.core.letta_memory.settings import log_settings, settings, telemetry_settings
...
class LogContextFilter(logging.Filter):
    ...
    Usage:
        from dreamtalk.brain.memory.core.letta_memory.log_context import set_log_context, update_log_context
