...
from dreamtalk.brain.memory.core.letta_memory.constants import CLI_WARNING_PREFIX
from dreamtalk.brain.memory.core.letta_memory.errors import LocalLLMConnectionError, LocalLLMError
from dreamtalk.brain.memory.core.letta_memory.helpers.datetime_helpers import get_utc_time_int
from dreamtalk.brain.memory.core.letta_memory.helpers.json_helpers import json_dumps
from dreamtalk.brain.memory.core.letta_memory.local_llm.constants import DEFAULT_WRAPPER
from dreamtalk.brain.memory.core.letta_memory.local_llm.function_parser import patch_function
from dreamtalk.brain.memory.core.letta_memory.local_llm.grammars.gbnf_grammar_generator import create_dynamic_model_from_function, generate_gbnf_grammar_and_documentation
from dreamtalk.brain.memory.core.letta_memory.local_llm.koboldcpp.api import get_koboldcpp_completion
from dreamtalk.brain.memory.core.letta_memory.local_llm.llamacpp.api import get_llamacpp_completion
from dreamtalk.brain.memory.core.letta_memory.local_llm.llm_chat_completion_wrappers import simple_summary_wrapper
from dreamtalk.brain.memory.core.letta_memory.local_llm.lmstudio.api import get_lmstudio_completion, get_lmstudio_completion_chatcompletions
from dreamtalk.brain.memory.core.letta_memory.local_llm.ollama.api import get_ollama_completion
from dreamtalk.brain.memory.core.letta_memory.local_llm.utils import get_available_wrappers
from dreamtalk.brain.memory.core.letta_memory.local_llm.vllm.api import get_vllm_completion
from dreamtalk.brain.memory.core.letta_memory.local_llm.webui.api import get_webui_completion
from dreamtalk.brain.memory.core.letta_memory.local_llm.webui.legacy_api import get_webui_completion as get_webui_completion_legacy
from dreamtalk.brain.memory.core.letta_memory.otel.tracing import log_event
from dreamtalk.brain.memory.core.letta_memory.prompts.gpt_summarize import SYSTEM as SUMMARIZE_SYSTEM_MESSAGE
from dreamtalk.brain.memory.core.letta_memory.schemas.message import Message as PydanticMessage
from dreamtalk.brain.memory.core.letta_memory.schemas.openai.chat_completion_response import ChatCompletionResponse, Choice, Message, ToolCall, UsageStatistics
from dreamtalk.brain.memory.core.letta_memory.utils import get_tool_call_id
...
def get_chat_completion(
    ...
    from dreamtalk.brain.memory.core.letta_memory.utils import printd
