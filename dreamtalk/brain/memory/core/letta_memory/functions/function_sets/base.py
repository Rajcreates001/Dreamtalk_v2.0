...
from dreamtalk.brain.memory.core.letta_memory.constants import CORE_MEMORY_LINE_NUMBER_WARNING
...
def conversation_search(
    ...
    from dreamtalk.brain.memory.core.letta_memory.constants import RETRIEVAL_QUERY_DEFAULT_PAGE_SIZE
