...
from dreamtalk.brain.memory.core.letta_memory.orm.group import Group as GroupModel
from dreamtalk.brain.memory.core.letta_memory.orm.groups_blocks import GroupsBlocks
...
from dreamtalk.brain.memory.core.letta_memory.schemas.group import Group as PydanticGroup, GroupCreate, GroupUpdate, InternalTemplateGroupCreate, ManagerType
...
class GroupManager:
    ...
    def _process_shared_block_relationship(
        ...
        from dreamtalk.brain.memory.core.letta_memory.orm import Agent, Block, BlocksAgents
