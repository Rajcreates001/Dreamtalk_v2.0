...
from dreamtalk.brain.memory.core.letta_memory.log_context import update_log_context
from dreamtalk.brain.memory.core.letta_memory.orm.agent import Agent as AgentModel
from dreamtalk.brain.memory.core.letta_memory.orm.errors import NoResultFound
from dreamtalk.brain.memory.core.letta_memory.orm.run import Run as RunModel
from dreamtalk.brain.memory.core.letta_memory.orm.run_metrics import RunMetrics as RunMetricsModel
...
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import AgentType, ComparisonOperator, MessageRole, PrimitiveType, RunStatus
from dreamtalk.brain.memory.core.letta_memory.schemas.job import LettaRequestConfig
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_message import LettaMessage
...
from dreamtalk.brain.memory.core.letta_memory.schemas.message import Message as PydanticMessage
from dreamtalk.brain.memory.core.letta_memory.schemas.run import Run as PydanticRun, RunUpdate
from dreamtalk.brain.memory.core.letta_memory.schemas.run_metrics import RunMetrics as PydanticRunMetrics
from dreamtalk.brain.memory.core.letta_memory.schemas.step import Step as PydanticStep
from dreamtalk.brain.memory.core.letta_memory.schemas.usage import LettaUsageStatistics, normalize_cache_tokens, normalize_reasoning_tokens
...
from dreamtalk.brain.memory.core.letta_memory.services.helpers.agent_manager_helper import validate_agent_exists_async
...
from dreamtalk.brain.memory.core.letta_memory.utils import enforce_types
...
class RunManager:
    ...
    async def list_runs(
        ...
        async with db_registry.async_session() as session:
            ...
            if order_by == "duration":
                ...
                from dreamtalk.brain.memory.core.letta_memory.services.helpers.run_manager_helper import _apply_pagination_async
    ...
    async def update_run_by_id_async(
        ...
        if is_terminal_update and update.stop_reason:
            try:
                from dreamtalk.brain.memory.core.letta_memory.schemas.agent import UpdateAgent
    ...
    async def cancel_run(self, actor: PydanticUser, agent_id: Optional[str] = None, run_id: Optional[str] = None) -> None:
        ...
        if was_pending_approval:
            ...
            if all_pending_tool_calls:
                from dreamtalk.brain.memory.core.letta_memory.constants import TOOL_CALL_DENIAL_ON_CANCEL
                from dreamtalk.brain.memory.core.letta_memory.schemas.letta_message import ApprovalReturn
                from dreamtalk.brain.memory.core.letta_memory.schemas.message import ApprovalCreate
