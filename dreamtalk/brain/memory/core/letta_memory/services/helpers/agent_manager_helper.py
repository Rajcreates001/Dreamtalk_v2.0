...
from dreamtalk.brain.memory.core.letta_memory import system
...
from dreamtalk.brain.memory.core.letta_memory.errors import LettaAgentNotFoundError
from dreamtalk.brain.memory.core.letta_memory.helpers import ToolRulesSolver
from dreamtalk.brain.memory.core.letta_memory.helpers.datetime_helpers import get_local_time
...
from dreamtalk.brain.memory.core.letta_memory.orm.sources_agents import SourcesAgents
from dreamtalk.brain.memory.core.letta_memory.otel.tracing import trace_method
from dreamtalk.brain.memory.core.letta_memory.prompts import gpt_system
...
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import AgentType, MessageRole
...
from dreamtalk.brain.memory.core.letta_memory.system import get_initial_boot_messages, get_login_event, package_function_response
...
async def build_passage_query(
    ...
    if embedded_text:
        if settings.database_engine is DatabaseChoice.POSTGRES:
            ...
            from dreamtalk.brain.memory.core.letta_memory.orm.sqlite_functions import adapt_array
