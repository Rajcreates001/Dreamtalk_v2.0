...
from dreamtalk.brain.memory.core.letta_memory.constants import CONVERSATION_SEARCH_TOOL_NAME, DEFAULT_MESSAGE_TOOL, DEFAULT_MESSAGE_TOOL_KWARG
from dreamtalk.brain.memory.core.letta_memory.log import get_logger
from dreamtalk.brain.memory.core.letta_memory.orm.conversation_messages import ConversationMessage
from dreamtalk.brain.memory.core.letta_memory.orm.errors import NoResultFound
from dreamtalk.brain.memory.core.letta_memory.orm.message import Message as MessageModel
from dreamtalk.brain.memory.core.letta_memory.otel.tracing import trace_method
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import MessageRole, PrimitiveType
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_message import LettaMessageUpdateUnion
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_message_content import ImageSourceType, LettaImage, MessageContentType
from dreamtalk.brain.memory.core.letta_memory.schemas.message import Message as PydanticMessage, MessageSearchResult, MessageUpdate
...
from dreamtalk.brain.memory.core.letta_memory.utils import enforce_types, fire_and_forget
...
class MessageManager:
    ...
    def _combine_assistant_tool_messages(self, messages: List[PydanticMessage]) -> List[PydanticMessage]:
        ...
        """
        from dreamtalk.brain.memory.core.letta_memory.constants import DEFAULT_MESSAGE_TOOL
    ...
    async def create_many_messages_async(
        ...
        from dreamtalk.brain.memory.core.letta_memory.helpers.tpuf_client import should_use_tpuf_for_messages
    ...
    async def delete_message_by_id_async(self, message_id: str, actor: PydanticUser, strict_mode: bool = False) -> bool:
        ...
        from dreamtalk.brain.memory.core.letta_memory.helpers.tpuf_client import TurbopufferClient, should_use_tpuf_for_messages
