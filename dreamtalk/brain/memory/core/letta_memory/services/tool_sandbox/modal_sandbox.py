...
from dreamtalk.brain.memory.core.letta_memory.constants import MODAL_DEFAULT_TOOL_NAME
...
class AsyncToolSandboxModal(AsyncToolSandboxBase):
    ...
    async def _wait_for_modal_function_deployment(self, timeout: int = 60):
        ...
        from dreamtalk.brain.memory.core.letta_memory.helpers.tool_helpers import generate_modal_function_name
