...
from dreamtalk.brain.memory.core.letta_memory.constants import LETTA_MULTI_AGENT_TOOL_MODULE_NAME
from dreamtalk.brain.memory.core.letta_memory.functions.helpers import generate_model_from_args_json_schema
...
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import ToolSourceType, ToolType
...
from dreamtalk.brain.memory.core.letta_memory.services.helpers.tool_execution_helper import add_imports_and_pydantic_schemas_for_args
from dreamtalk.brain.memory.core.letta_memory.services.helpers.tool_parser_helper import convert_param_to_str_value, parse_function_arguments
...
from dreamtalk.brain.memory.core.letta_memory.types import JsonDict, JsonValue
...
class AsyncToolSandboxBase(ABC):
    ...
    async def _generate_typescript_execution_script(self, agent_state: Optional[AgentState]) -> str:
        ...
        """
        from dreamtalk.brain.memory.core.letta_memory.services.tool_sandbox.typescript_generator import generate_typescript_execution_script
