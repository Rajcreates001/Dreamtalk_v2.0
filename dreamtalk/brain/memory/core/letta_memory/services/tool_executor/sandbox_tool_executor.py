...
from dreamtalk.brain.memory.core.letta_memory.functions.ast_parsers import coerce_dict_args_by_annotations, get_function_annotations_from_source
...
from dreamtalk.brain.memory.core.letta_memory.services.sandbox_credentials_service import SandboxCredentialsService
from dreamtalk.brain.memory.core.letta_memory.services.tool_executor.tool_executor_base import ToolExecutor
from dreamtalk.brain.memory.core.letta_memory.services.tool_sandbox.local_sandbox import AsyncToolSandboxLocal
    ...
    async def execute(
        ...
        try:
            ...
            if tool_requests_modal and modal_configured:
                try:
                    from dreamtalk.brain.memory.core.letta_memory.services.tool_sandbox.modal_sandbox import AsyncToolSandboxModal
            ...
            if tool_execution_result is None:
                if tool_settings.sandbox_type == SandboxType.E2B:
                    from dreamtalk.brain.memory.core.letta_memory.services.tool_sandbox.e2b_sandbox import AsyncToolSandboxE2B
