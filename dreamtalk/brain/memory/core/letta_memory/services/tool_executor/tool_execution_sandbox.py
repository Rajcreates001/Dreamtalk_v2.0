...
from dreamtalk.brain.memory.core.letta_memory.services.helpers.tool_execution_helper import (
...
class ToolExecutionSandbox:
    ...
    def generate_execution_script(self, agent_state: AgentState, wrap_print_with_markers: bool = False) -> str:
        ...
        if self.args:
            ...
            code += "try:\n"
            code += "    from dreamtalk.brain.memory.core.letta_memory.functions.ast_parsers import coerce_dict_args_by_annotations\n"
