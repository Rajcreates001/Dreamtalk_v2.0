...
if TYPE_CHECKING:
    from dreamtalk.brain.memory.core.letta_memory.agents.voice_sleeptime_agent import VoiceSleeptimeAgent
...
from dreamtalk.brain.memory.core.letta_memory.errors import ContextWindowExceededError, LLMProviderOverloaded, LLMRateLimitError
...
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import AgentType, LLMCallType, MessageRole, ProviderCategory, ProviderType
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_message_content import ImageContent, TextContent
...
from dreamtalk.brain.memory.core.letta_memory.system import package_summarize_message_no_counts
...
class Summarizer:
    ...
    async def _partial_evict_buffer_summarization(
        ...
        from dreamtalk.brain.memory.core.letta_memory.settings import summarizer_settings
...
async def simple_summary(
    ...
    """
    from dreamtalk.brain.memory.core.letta_memory.prompts.summarizer_prompt import ALL_PROMPT
    from dreamtalk.brain.memory.core.letta_memory.services.telemetry_manager import TelemetryManager
...
async def _get_summarizer_fallback_config(llm_config: LLMConfig, actor: User) -> LLMConfig | None:
    ...
    if endpoint_type in ("zai", "zai_coding"):
        from dreamtalk.brain.memory.core.letta_memory.services.llm_router.llm_router_client import _build_baseten_config
