...
from dreamtalk.brain.memory.core.letta_memory.errors import ContextWindowExceededError
...
from dreamtalk.brain.memory.core.letta_memory.services.summarizer.self_summarizer import self_summarize_all, self_summarize_sliding_window
from dreamtalk.brain.memory.core.letta_memory.services.summarizer.summarizer_all import summarize_all
from dreamtalk.brain.memory.core.letta_memory.services.summarizer.summarizer_config import CompactionSettings, get_default_prompt_for_mode, get_default_summarizer_model
from dreamtalk.brain.memory.core.letta_memory.services.summarizer.summarizer_sliding_window import (
    count_tokens,
    ...
    if trigger_threshold is not None and context_token_estimate is not None and context_token_estimate >= trigger_threshold:
        ...
        if context_token_estimate is not None and context_token_estimate >= trigger_threshold:
            ...
            if system_prompt_token_estimate is not None and system_prompt_token_estimate >= agent_llm_config.context_window:
                from dreamtalk.brain.memory.core.letta_memory.errors import SystemPromptTokenExceededError
