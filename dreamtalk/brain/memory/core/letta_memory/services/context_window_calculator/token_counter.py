...
class TiktokenCounter(TokenCounter):
    ...
    async def count_message_tokens(self, messages: List[Dict[str, Any]]) -> int:
        ...
        try:
            from dreamtalk.brain.memory.core.letta_memory.local_llm.utils import num_tokens_from_messages
    ...
    async def count_tool_tokens(self, tools: List[OpenAITool]) -> int:
        if not tools:
            return 0
        from dreamtalk.brain.memory.core.letta_memory.local_llm.utils import num_tokens_from_functions
