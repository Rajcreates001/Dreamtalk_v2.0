...
from dreamtalk.brain.memory.core.letta_memory.errors import LettaInvalidArgumentError, LettaToolNameConflictError, LettaToolNameSchemaMismatchError
from dreamtalk.brain.memory.core.letta_memory.functions.functions import load_function_set
from dreamtalk.brain.memory.core.letta_memory.helpers.tool_helpers import compute_tool_hash, generate_modal_function_name
...
from dreamtalk.brain.memory.core.letta_memory.orm.tool import Tool as ToolModel
from dreamtalk.brain.memory.core.letta_memory.otel.tracing import trace_method, tracer
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import PrimitiveType, SandboxType, ToolType
from dreamtalk.brain.memory.core.letta_memory.schemas.tool import Tool as PydanticTool, ToolCreate, ToolUpdate
...
from dreamtalk.brain.memory.core.letta_memory.services.helpers.agent_manager_helper import calculate_multi_agent_tools
from dreamtalk.brain.memory.core.letta_memory.services.mcp.types import SSEServerConfig, StdioServerConfig
from dreamtalk.brain.memory.core.letta_memory.services.tool_schema_generator import generate_schema_for_tool_creation, generate_schema_for_tool_update
from dreamtalk.brain.memory.core.letta_memory.settings import settings, tool_settings
from dreamtalk.brain.memory.core.letta_memory.utils import enforce_types, fire_and_forget, printd
...
def modal_tool_wrapper(tool: PydanticTool, actor: PydanticUser, sandbox_env_vars: dict | None = None, project_id: str = "default"):
    ...
    def modal_function(
        ...
        if agent_state:
            try:
                from dreamtalk.brain.memory.core.letta_memory.schemas.agent import AgentState as AgentStateModel
        ...
        with contextlib.redirect_stdout(stdout_capture), contextlib.redirect_stderr(stderr_capture):
            try:
                ...
                try:
                    from dreamtalk.brain.memory.core.letta_memory.functions.ast_parsers import coerce_dict_args_by_annotations
...
class ToolManager:
    ...
    async def _atomic_upsert_tool_postgresql(
        ...
        from dreamtalk.brain.memory.core.letta_memory.helpers.tpuf_client import should_use_tpuf_for_tools
    ...
    async def search_tools_async(
        ...
        """
        from dreamtalk.brain.memory.core.letta_memory.helpers.tpuf_client import TurbopufferClient, should_use_tpuf_for_tools
