...
from dreamtalk.brain.memory.core.letta_memory.constants import (
    BASE_MEMORY_TOOLS,
...
from dreamtalk.brain.memory.core.letta_memory.errors import LettaError
from dreamtalk.brain.memory.core.letta_memory.helpers import ToolRulesSolver
...
from dreamtalk.brain.memory.core.letta_memory.orm import (
    Agent as AgentModel,
    AgentsTags,
    ArchivalPassage,
    Block as BlockModel,
...
from dreamtalk.brain.memory.core.letta_memory.orm.sqlalchemy_base import AccessType
from dreamtalk.brain.memory.core.letta_memory.otel.tracing import trace_method
from dreamtalk.brain.memory.core.letta_memory.prompts.prompt_generator import PromptGenerator
from dreamtalk.brain.memory.core.letta_memory.schemas.agent import (
    AgentState as PydanticAgentState,
    CreateAgent,
    InternalTemplateAgentCreate,
    UpdateAgent,
)
from dreamtalk.brain.memory.core.letta_memory.schemas.block import DEFAULT_BLOCKS, Block as PydanticBlock, BlockUpdate
from dreamtalk.brain.memory.core.letta_memory.schemas.embedding_config import EmbeddingConfig
from dreamtalk.brain.memory.core.letta_memory.schemas.enums import AgentType, PrimitiveType, TagMatchMode, ToolType, VectorDBProvider
from dreamtalk.brain.memory.core.letta_memory.schemas.environment_variables import AgentEnvironmentVariable as PydanticAgentEnvVar
from dreamtalk.brain.memory.core.letta_memory.schemas.file import FileMetadata as PydanticFileMetadata
from dreamtalk.brain.memory.core.letta_memory.schemas.group import Group as PydanticGroup, ManagerType
from dreamtalk.brain.memory.core.letta_memory.schemas.letta_stop_reason import StopReasonType
from dreamtalk.brain.memory.core.letta_memory.schemas.llm_config import LLMConfig
from dreamtalk.brain.memory.core.letta_memory.schemas.memory import ContextWindowOverview, Memory
from dreamtalk.brain.memory.core.letta_memory.schemas.message import Message, Message as PydanticMessage, MessageCreate, MessageUpdate
from dreamtalk.brain.memory.core.letta_memory.schemas.passage import Passage as PydanticPassage
from dreamtalk.brain.memory.core.letta_memory.schemas.secret import Secret
from dreamtalk.brain.memory.core.letta_memory.schemas.source import Source as PydanticSource
from dreamtalk.brain.memory.core.letta_memory.schemas.tool import Tool as PydanticTool
from dreamtalk.brain.memory.core.letta_memory.schemas.tool_rule import ContinueToolRule, RequiresApprovalToolRule, TerminalToolRule
from dreamtalk.brain.memory.core.letta_memory.schemas.user import User as PydanticUser
from dreamtalk.brain.memory.core.letta_memory.server.db import db_registry
...
from dreamtalk.brain.memory.core.letta_memory.services.context_window_calculator.context_window_calculator import ContextWindowCalculator
...
from dreamtalk.brain.memory.core.letta_memory.services.conversation_manager import ConversationManager
from dreamtalk.brain.memory.core.letta_memory.services.file_processor.chunker.line_chunker import LineChunker
from dreamtalk.brain.memory.core.letta_memory.services.files_agents_manager import FileAgentManager
from dreamtalk.brain.memory.core.letta_memory.services.helpers.agent_manager_helper import (
    _apply_filters,
...
from dreamtalk.brain.memory.core.letta_memory.settings import DatabaseChoice, settings
from dreamtalk.brain.memory.core.letta_memory.utils import (
    bounded_gather,
...
from dreamtalk.brain.memory.core.letta_memory.validators import raise_on_invalid_id
...
class AgentManager:
    ...
    async def create_agent_async(
        ...
        async with db_registry.async_session() as session:
            async with session.begin():
                ...
                from dreamtalk.brain.memory.core.letta_memory.services.summarizer.summarizer_config import CompactionSettings, get_default_summarizer_model
        ...
        async with db_registry.async_session() as session, session.begin():
            ...
            if agent_update.compaction_settings is not None:
                ...
                if (
                    ...
                    from dreamtalk.brain.memory.core.letta_memory.services.summarizer.summarizer_config import get_default_prompt_for_mode
    ...
    async def get_agent_archive_ids_async(self, agent_id: str, actor: PydanticUser) -> List[str]:
        ...
        from dreamtalk.brain.memory.core.letta_memory.orm import ArchivesAgents
        ...
        if embed_query and query_text and embedding_config:
            ...
            if target_archive_id:
                ...
                if archive.vector_db_provider == VectorDBProvider.TPUF:
                    from dreamtalk.brain.memory.core.letta_memory.helpers.tpuf_client import TurbopufferClient
