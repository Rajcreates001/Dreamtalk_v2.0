...
from dreamtalk.brain.memory.core.letta_memory.schemas.source import Source as PydanticSource, SourceUpdate
...
from dreamtalk.brain.memory.core.letta_memory.utils import bounded_gather, decrypt_agent_secrets, enforce_types, printd
    ...
    async def _upsert_sources_individually(self, source_data_list: List[PydanticSource], actor: PydanticUser) -> List[PydanticSource]:
        ...
        for source in source_data_list:
            ...
            if existing_source:
                ...
                from dreamtalk.brain.memory.core.letta_memory.schemas.source import SourceUpdate
