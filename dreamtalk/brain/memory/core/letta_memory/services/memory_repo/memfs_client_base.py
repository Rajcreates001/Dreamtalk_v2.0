...
from dreamtalk.brain.memory.core.letta_memory.schemas.memory_repo import MemoryCommit
from dreamtalk.brain.memory.core.letta_memory.schemas.user import User as PydanticUser
from dreamtalk.brain.memory.core.letta_memory.services.memory_repo.block_markdown import parse_block_markdown, serialize_block
from dreamtalk.brain.memory.core.letta_memory.services.memory_repo.git_operations import GitOperations
from dreamtalk.brain.memory.core.letta_memory.services.memory_repo.path_mapping import memory_block_label_from_markdown_path
    ...
    async def update_block_async(
        ...
        *,
        ...
        Returns:
            Commit details
        """
        from dreamtalk.brain.memory.core.letta_memory.schemas.memory_repo import FileChange
