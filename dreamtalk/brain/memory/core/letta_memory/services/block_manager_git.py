...
from dreamtalk.brain.memory.core.letta_memory.constants import CORE_MEMORY_BLOCK_CHAR_LIMIT
...
from dreamtalk.brain.memory.core.letta_memory.schemas.block import Block as PydanticBlock, BlockUpdate, CreateBlock
    ...
    async def _sync_block_to_postgres(
        ...
        async with db_registry.async_session() as session:
            ...
            if block:
                ...
                from dreamtalk.brain.memory.core.letta_memory.schemas.block import BaseBlock
