  ...
  return (
    <group>
      ...
      <mesh ref={midRef}>
        ...
        <meshBasicMaterial color="var(--secondary)" transparent opacity={0.2} />
      </mesh>
  ...
  return (
    <group>
      <mesh ref={ref}>
        ...
        <meshBasicMaterial color="var(--primary)" transparent opacity={0.08} wireframe depthWrite={false} />
      </mesh>
      <mesh ref={ref2}>
  ...
  const nodeData = useMemo(() => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      data.push({
        ...
        color: i % 3 === 0 ? "var(--primary)" : i % 3 === 1 ? "var(--secondary)" : "var(--secondary)",
...
function NeuralConnections() {
  ...
  return (
    <lineSegments ref={lineRef}>
      ...
      <lineBasicMaterial color="var(--primary)" transparent opacity={0.08} />
    </lineSegments>
  )
}
