        ...
        {showWelcome ? (
          ...
          <motion.div key="role" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="space-y-5">
            ...
            {ROLES.map((role, i) => {
              ...
              return (
                <motion.button
                  ...
                  style={{
                    background: isSelected ? `${rc}12` : "rgba(15,23,42,0.8)",
                    border: "1px solid",
            ...
            <div className="pt-2">
              ...
              <div className="flex gap-2">
                <button onClick={loginWithGoogle} className="flex-1 py-2.5 rounded-xl border border-white/[0.06] text-[11px] font-medium text-foreground-muted hover:text-foreground hover:bg-white/[0.04] transition-all bg-white/[0.04]">Google</button>
                <button onClick={loginWithGitHub} className="flex-1 py-2.5 rounded-xl border border-white/[0.06] text-[11px] font-medium text-foreground-muted hover:text-foreground hover:bg-white/[0.04] transition-all bg-white/[0.04]">GitHub</button>
                <button onClick={loginWithMicrosoft} className="flex-1 py-2.5 rounded-xl border border-white/[0.06] text-[11px] font-medium text-foreground-muted hover:text-foreground hover:bg-white/[0.04] transition-all bg-white/[0.04]">Microsoft</button>
              </div>
            </div>
          ...
          <motion.div key="login" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" required
                    className="w-full h-11 pl-9 pr-3 rounded-[14px] bg-white/[0.04] border border-white/[0.06] text-xs text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 transition-all"
                  />
                </div>
              </div>
              <div className="space-y-1">
            ...
            <div className="flex gap-2 mt-3">
              <button onClick={loginWithGoogle} className="flex-1 py-2 rounded-xl border border-white/[0.06] text-[11px] font-medium text-foreground-muted hover:text-foreground hover:bg-white/[0.04] transition-all bg-white/[0.04]">Google</button>
              <button onClick={loginWithGitHub} className="flex-1 py-2 rounded-xl border border-white/[0.06] text-[11px] font-medium text-foreground-muted hover:text-foreground hover:bg-white/[0.04] transition-all bg-white/[0.04]">GitHub</button>
              <button onClick={loginWithMicrosoft} className="flex-1 py-2 rounded-xl border border-white/[0.06] text-[11px] font-medium text-foreground-muted hover:text-foreground hover:bg-white/[0.04] transition-all bg-white/[0.04]">Microsoft</button>
            </div>
