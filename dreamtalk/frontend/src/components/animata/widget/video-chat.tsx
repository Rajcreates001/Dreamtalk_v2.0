  ...
  return (
    ...
    >
      ...
      >
        ...
        <YourImageSlot minimize={minimize} imageAlternate="Your Name" imageSource="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=800&auto=format&fit=crop" />
      </motion.div>
    </motion.div>
  );
}
