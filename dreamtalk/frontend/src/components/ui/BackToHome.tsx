...
export function BackToHome() {
  return (
    <Link href="/">
      ...
      >
        <ArrowLeft className="h-3.5 w-3.5 text-[#94A3B8] group-hover:text-[#F8FAFC] transition-colors" />
        <div className="hidden sm:flex items-center gap-1.5">
          <div className="w-4 h-4 rounded-[4px] bg-gradient-to-br from-[#7C5CFF] to-[#00E5FF] flex items-center justify-center">
            <Sparkles className="h-2 w-2 text-white" />
          </div>
          <span className="text-[11px] font-medium text-[#94A3B8] group-hover:text-[#F8FAFC] transition-colors">DreamTalk</span>
        </div>
      </motion.div>
    </Link>
  )
