...
const BRAIN_AREAS: Record<string, { label: string; color: string; description: string }> = {
  ...
  dacc: { label: "dACC", color: "var(--destructive)", description: "Conflict monitoring" },
  insula: { label: "Insula", color: "var(--burgundy)", description: "Emotion processing" },
  ipl: { label: "IPL", color: "var(--secondary)", description: "Context integration" },
  bg: { label: "Basal Ganglia", color: "var(--warning)", description: "Action selection" },
};
