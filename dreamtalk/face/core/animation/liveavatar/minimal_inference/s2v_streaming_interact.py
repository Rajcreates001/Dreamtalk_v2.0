...
from dreamtalk.face.core.animation.liveavatar.models.wan.wan_2_2.configs import MAX_AREA_CONFIGS, SIZE_CONFIGS, SUPPORTED_SIZES, WAN_CONFIGS
from dreamtalk.face.core.animation.liveavatar.models.wan.wan_2_2.distributed.util import init_distributed_group
from dreamtalk.face.core.animation.liveavatar.models.wan.wan_2_2.utils.prompt_extend import DashScopePromptExpander, QwenPromptExpander
from dreamtalk.face.core.animation.liveavatar.models.wan.wan_2_2.utils.utils import merge_video_audio, save_video, str2bool
from dreamtalk.face.core.animation.liveavatar.utils.args_config import parse_args_for_training_config as training_config_parser
from dreamtalk.face.core.animation.liveavatar.utils.router.synthesize_audio import merge_multiple_audio_files
...
def generate(args, training_settings):
    ...
    if world_size > 1:
        ...
        from dreamtalk.face.core.animation.liveavatar.models.wan.causal_s2v_pipeline_tpp import WanS2V
        ...
        from dreamtalk.face.core.animation.liveavatar.models.wan.causal_s2v_pipeline import WanS2V
    ...
    if "s2v" in args.task:
        ...
        if args.fp8:
            if hasattr(torch, "_scaled_mm"):
                from dreamtalk.face.core.animation.liveavatar.utils.fp8_linear import replace_linear_with_scaled_fp8
