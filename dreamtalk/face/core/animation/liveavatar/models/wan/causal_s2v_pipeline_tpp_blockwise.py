...
from dreamtalk.face.core.animation.liveavatar.utils.router.utils import process_masks_to_routing_logits
...
class WanS2V:
    ...
    def __init__(
        ...
        if self.is_training:
            from dreamtalk.face.core.animation.liveavatar.models.wan.flow_match import FlowMatchScheduler_Omni
