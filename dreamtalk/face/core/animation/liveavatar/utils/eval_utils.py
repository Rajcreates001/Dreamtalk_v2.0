...
from dreamtalk.face.core.animation.liveavatar.utils.sync_net.run_pipeline import run_syncnet
...
def calculate_fvd(videos1, videos2, device, method='styleganv'):
    ...
    if method == 'styleganv':
        from dreamtalk.face.core.animation.liveavatar.utils.fvd.styleganv.fvd import get_fvd_feats, frechet_distance, load_i3d_pretrained
    elif method == 'videogpt':
        from dreamtalk.face.core.animation.liveavatar.utils.fvd.videogpt.fvd import load_i3d_pretrained
        from dreamtalk.face.core.animation.liveavatar.utils.fvd.videogpt.fvd import get_fvd_logits as get_fvd_feats
        from dreamtalk.face.core.animation.liveavatar.utils.fvd.videogpt.fvd import frechet_distance
