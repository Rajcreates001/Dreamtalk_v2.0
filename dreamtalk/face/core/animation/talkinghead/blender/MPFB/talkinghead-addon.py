...
# Original: The MIT License (MIT) Copyright (c) 2026 Mika Suominen
# Function "apply_modifiers" adapted from "ApplyModifierForObjectWithShapeKeys"
# (https://github.com/przemir/ApplyModifierForObjectWithShapeKeys)
# Copyright (c) 2015 Przemyslaw Bgard, licensed under MIT License
...
def copy_pose(bones, only_selected = True, decimal_places = 4, skip = ["Buttock", "Breast", "Eye", "Jaw", "Orbicularis", "_End", "4"]):
    ...
    # Bone quaternions
    ROOT_FIX = Quaternion((1, 0, 0), -pi / 2)  # -90 deg X
    for bone in bones:
        # Only selected bones
...
BONE_AXES_DATA_A = {
    ...
    "HeadTop_End": [0.0, -0.999963, 0.008631], "LeftShoulder": [-0.151138, -0.082852, -0.985034],
