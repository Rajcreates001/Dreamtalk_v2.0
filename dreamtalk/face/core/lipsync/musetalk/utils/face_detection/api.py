...
class FaceAlignment:
    def __init__(self, landmarks_type, network_size=NetworkSize.LARGE,
                 device=None, flip_input=False, face_detector='sfd', verbose=False):
        if device is None:
...
#             torch.backends.cudnn.allow_tf32 = True
        ...
        face_detector_module = __import__('dreamtalk.face.core.lipsync.musetalk.utils.face_detection.detection.' + face_detector,
