...
# Source: GPT_SoVITS/text/cleaner.py
...
def clean_text(text, language, version=None):
    ...
    language_module = __import__("dreamtalk.voice.core.tts." + language_module_map[language], fromlist=[language_module_map[language]])
