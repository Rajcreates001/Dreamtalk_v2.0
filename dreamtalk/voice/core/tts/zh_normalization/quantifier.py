...
measure_dict = {"cm2": "平方厘米", "cm²": "平方厘米", "cm3": "立方厘米", "cm³": "立方厘米", "cm": "厘米", "db": "分贝", "ds": "毫秒", "kg": "千克", "km": "千米", "m2": "平方米", "m²": "平方米", "m³": "立方米", "m3": "立方米", "ml": "毫升", "m": "米", "mm": "毫米", "s": "秒"}
...
def replace_temperature(match) -> str:
    ...
    return f"{sign_str}{num2str(temperature)}{'摄氏度' if unit == '摄氏度' else '度'}"
