...
ALL_SPECIAL_TOKENS = [
    ...
    PHONEME_START_TOKEN, PHONEME_END_TOKEN,
    MODALITY_TEXT_TOKEN, MODALITY_VOICE_TOKEN, MODALITY_INTERLEAVE_TOKEN,
    AUDIO_START_TOKEN, AUDIO_END_TOKEN, AUDIO_EMBED_TOKEN,
    *SEMANTIC_TOKENS,
]
...
class FishTokenizer:
    def __init__(self, model_path: str):
        ...
        if not valid_ids:
            logger.error("No semantic tokens found in vocab!")
