...
# Source: GPT_SoVITS/AR/modules/activation.py
...
class MultiheadAttention(Module):
    ...
    def forward(self, query, key, value, key_padding_mask=None, need_weights=True, attn_mask=None, average_attn_weights=True, cache=None):
        if self.batch_first:
