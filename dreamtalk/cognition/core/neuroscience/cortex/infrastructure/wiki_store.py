...
from ..core.wiki_layout import PAGE_KINDS
from ..core.wiki_sync import build_from_memory
...
def _try_reindex(root: Path) -> None:
    ...
    """
    try:
        from ..core.wiki_pages import build_index
        from ..core.wiki_readme import build_plain_readme
