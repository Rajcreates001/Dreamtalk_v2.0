...
from .ablation import Mechanism, is_mechanism_disabled
...
def hdc_rerank(
    ...
    *,
    ...
    from .hdc_encoder import compute_hdc_scores
...
def spreading_activation_expand(
    ...
    *,
    ...
    from .query_decomposition import extract_query_entities
...
def _resolve_query_entity_ids(query: str, store: Any) -> set[int]:
    ...
    """
    from .query_decomposition import extract_query_entities
    from ..shared.text import extract_keywords
...
def dendritic_modulate(
    ...
    **Entity-set source.** When ``store`` exposes
    ...
    from ..shared.similarity import jaccard_similarity
...
def reconsolidation_apply(
    ...
    *,
    ...
    from .reconsolidation import compute_reconsolidation_action
    from ..shared.vader import vader_compound
