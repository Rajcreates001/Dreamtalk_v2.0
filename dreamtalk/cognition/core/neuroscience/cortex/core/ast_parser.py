...
from .ast_extractor_registry import build_extra_extractors
from .codebase_parser import (
    FileAnalysis,
    ImportInfo,
    SymbolDef,
    detect_language,
...
def parse_file_ast(path: str, content: bytes) -> FileAnalysis:
    ...
    if not result:
        from .codebase_parser import parse_file
    ...
    from .ast_extractors import extract_calls_per_function
...
def _extract_go(
    ...
    from .ast_extractors import extract_calls_generic
    from .ast_extractors_extra import (
