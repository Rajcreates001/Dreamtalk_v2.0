...
from ..infrastructure.config import CLAUDE_DIR
...
def gist_oversized_content(content: str) -> str:
    ...
    """
    from ..core.gist_extraction import extract_gist, needs_gist

    if not needs_gist(content):
        return content
    try:
        from ..infrastructure.artifact_store import store_artifact
