...
from ..core.codebase_parser import (
    EXT_TO_LANG,
    build_memory_content,
    parse_file,
)
from .codebase_analyze_helpers import (
...
def _parse_one_file(path: str, content: str) -> Any:
    ...
    from ..core.ast_parser import is_available, parse_file_ast
...
def _run_graph_analysis(
    ...
    from ..core.codebase_graph import (
        compute_centrality,
        detect_communities,
        detect_god_nodes,
        extract_inheritance,
    ...
    from ..core.codebase_type_resolver import resolve_type_references
    from .codebase_analyze_helpers import (
