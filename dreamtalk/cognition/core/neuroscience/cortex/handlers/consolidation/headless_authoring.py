...
def _project_source_for_page(
    ...
    if not domain or not isinstance(domain, str):
        return None, None
    try:
        from ...core.wiki_coverage import _project_source_root
    except Exception:
        return None, None
...
def _scan_pages_with_gaps(wiki_root: Path) -> list[tuple[Path, dict[str, Any], str]]:
    ...
    try:
        from ...core.wiki_curation_gaps import missing_sections
    except Exception:
...
def drain_missing_anchors(
    ...
    *,
    ...
    from ...shared.domain_mapping import _build_registry
