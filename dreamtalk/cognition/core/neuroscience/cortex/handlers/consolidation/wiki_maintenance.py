...
async def _invoke_wiki_purge(args: dict[str, Any]) -> dict[str, Any]:
    ...
    from ..wiki_purge import handler as wiki_purge_handler
...
async def run_wiki_maintenance(
    ...
    *,
    ...
    try:
        from ...core.wiki_coverage_dashboard import write_dashboards
        from ...infrastructure.config import WIKI_ROOT as _WR
    ...
    # Curation backlog.
    try:
        from ...core.auto_curator import count_pending_clusters_streamed
        from ...core.wiki_coverage import (
            _project_source_root,
            audit_all_domains,
            audit_all_file_coverage,
        )
        from ...core.wiki_drift import audit_wiki_drift
