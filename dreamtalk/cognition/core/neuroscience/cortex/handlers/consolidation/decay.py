...
from ...core.decay_cycle import compute_entity_decay
from ...core.tripartite_calcium import apply_metabolic_modulation
from ...core.tripartite_synapse import (
    AstrocyteTerritory,
    update_territory,
)
from .chunks import iter_memory_chunks
