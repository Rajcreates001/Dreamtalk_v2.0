...
async def handler(args: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    from .wiki_compile import handler as h_compile
    from .wiki_curate import handler as h_curate
    from .wiki_emerge import handler as h_emerge
    from .wiki_extract import handler as h_extract
    from .wiki_resolve import handler as h_resolve
    from .wiki_synthesize import handler as h_synth
