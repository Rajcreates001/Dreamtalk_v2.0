...
from ..core import emergence_metrics
from .consolidation.cascade import run_cascade_advancement
from .consolidation.cls import run_cls_cycle
from .consolidation.compression import run_compression_cycle
from .consolidation.decay import run_decay_cycle
from .consolidation.entity_merge import run_entity_merge_cycle
from .consolidation.homeostatic import run_homeostatic_cycle
from .consolidation.memify import run_memify_cycle
from .consolidation.plasticity import run_plasticity_cycle
from .consolidation.pruning import run_pruning_cycle
from .consolidation.sleep import run_deep_sleep
from .consolidation.transfer import run_two_stage_transfer
from .consolidation.wiki_maintenance import run_wiki_maintenance
from ..infrastructure.embedding_engine import (
    EmbeddingEngine,
...
from ._tool_meta import IDEMPOTENT_WRITE
...
async def handler(args: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        from ..hooks.consolidate_background import _write_stamp
