...
def _count_pending_curations(conn) -> int:
    ...
    """
    try:
        from ..core.auto_curator import count_pending_clusters
...
def _auto_backfill() -> int:
    ...
    try:
        ...
        from ..handlers.backfill_memories import handler as backfill_handler
...
def _auto_wire_pipeline() -> None:
    ...
    """
    try:
        from ..infrastructure.pipeline_discovery import (
...
def _maybe_background_consolidate() -> None:
    ...
    """
    try:
        from .consolidate_background import (
            STAMP_PATH,
            read_stamp,
        )
...
def _maybe_background_reanalyze() -> None:
    ...
    try:
        ...
        from ..infrastructure.pipeline_graph_ttl import graph_is_stale
...
def _lookup_cached_graph_path(project_root: str) -> str | None:
    ...
    try:
        from ..handlers.ingest_helpers import (
            code_graph_tag,
        )
    except Exception:
        return None
