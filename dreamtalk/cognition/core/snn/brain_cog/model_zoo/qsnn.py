...
from dreamtalk.cognition.core.snn.brain_cog.datasets.gen_input_signal import lambda_max, dt
from dreamtalk.cognition.core.snn.brain_cog.base.encoder import QSEncoder
...
class Net(nn.Module):
    ...
    def __init__(self, net_size):
        ...
        self.kernel = torch.from_numpy(kernel[:, np.newaxis])
