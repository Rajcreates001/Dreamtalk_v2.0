...
from dreamtalk.cognition.core.snn.brain_cog.model_zoo.NeuEvo.operations import *
from torch.autograd import Variable
from dreamtalk.cognition.core.snn.brain_cog.model_zoo.NeuEvo.genotypes import PRIMITIVES
from dreamtalk.cognition.core.snn.brain_cog.model_zoo.NeuEvo.genotypes import Genotype
from . import parse

from dreamtalk.cognition.core.snn.brain_cog.base.connection.layer import VotingLayer
from dreamtalk.cognition.core.snn.brain_cog.base.node.node import *
from dreamtalk.cognition.core.snn.brain_cog.model_zoo.base_module import BaseModule
...
class Network(BaseModule):
    ...
    def new(self):
        ...
        model_new = Network(self._C, self._num_classes,
                            self._layers, self._criterion).to(_dev)
    ...
    def _initialize_alphas(self):
        ...
        self.alphas_normal = Variable(
            0.5 * torch.randn(2, k, num_ops).to(_dev), requires_grad=True)
