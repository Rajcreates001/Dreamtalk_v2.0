...
from dreamtalk.cognition.core.snn.brain_cog.datasets.NOmniglot.nomniglot_full import NOmniglotfull
from dreamtalk.cognition.core.snn.brain_cog.datasets.NOmniglot.nomniglot_nw_ks import NOmniglotNWayKShot
from dreamtalk.cognition.core.snn.brain_cog.datasets.NOmniglot.nomniglot_pair import NOmniglotTrainSet, NOmniglotTestSet
from dreamtalk.cognition.core.snn.brain_cog.datasets.ESimagenet.ES_imagenet import ESImagenet_Dataset
from dreamtalk.cognition.core.snn.brain_cog.datasets.ESimagenet.reconstructed_ES_imagenet import ESImagenet2D_Dataset
from dreamtalk.cognition.core.snn.brain_cog.datasets.CUB2002011 import CUB2002011
from dreamtalk.cognition.core.snn.brain_cog.datasets.TinyImageNet import TinyImageNet
from dreamtalk.cognition.core.snn.brain_cog.datasets.StanfordDogs import StanfordDogs
from dreamtalk.cognition.core.snn.brain_cog.datasets.bullying10k import BULLYINGDVS
...
def get_UCF101DVS_data(batch_size, step, **kwargs):
    ...
    """
    size = kwargs['size'] if 'size' in kwargs else 48
    sensor_size = dreamtalk.cognition.core.snn.brain_cog.datasets.ucf101_dvs.UCF101DVS.sensor_size
    train_transform = transforms.Compose([
        # tonic.transforms.Denoise(filter_time=10000),
        # tonic.transforms.DropEvent(p=0.1),
        tonic.transforms.ToFrame(sensor_size=sensor_size, n_time_bins=step), ])
    test_transform = transforms.Compose([
        # tonic.transforms.Denoise(filter_time=10000),
        tonic.transforms.ToFrame(sensor_size=sensor_size, n_time_bins=step), ])
    train_dataset = dreamtalk.cognition.core.snn.brain_cog.datasets.ucf101_dvs.UCF101DVS(os.path.join(DATA_DIR, 'UCF101DVS'), train=True, transform=train_transform)
    test_dataset = dreamtalk.cognition.core.snn.brain_cog.datasets.ucf101_dvs.UCF101DVS(os.path.join(DATA_DIR, 'UCF101DVS'), train=False, transform=test_transform)
...
def get_HMDBDVS_data(batch_size, step, **kwargs):
    sensor_size = dreamtalk.cognition.core.snn.brain_cog.datasets.hmdb_dvs.HMDBDVS.sensor_size
    ...
    train_dataset = dreamtalk.cognition.core.snn.brain_cog.datasets.hmdb_dvs.HMDBDVS(os.path.join(DATA_DIR, 'HMDBDVS'), transform=train_transform)
    test_dataset = dreamtalk.cognition.core.snn.brain_cog.datasets.hmdb_dvs.HMDBDVS(os.path.join(DATA_DIR, 'HMDBDVS'), transform=test_transform)
